...
const Footer = ({ words }) => (
  <footer
    ...
    className="tc-l bg-center cover bg-black mt5"
  >
    <div className="w-100 ph3 pv2 bg-black-80 tc">
      <a
        className="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2"
        href="https://github.com/anamariasosam/react_dev_game"
        title="GitHub"
        target="_new"
      >
        <svg
      ...
      <a
        className="link white-60 bg-transparent hover-white inline-flex items-center ma2 tc br2 pa2"
        href={`http://twitter.com/share?text=I%20found%20${words}%20words%20in&url=${window.location.origin}&hashtags=dev,game`}
        title="Twitter"
      >
        <svg
          className="dib h2 w2"
